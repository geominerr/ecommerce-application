  ...
  public async getHtml(): Promise<string> {
    ...
    <div class="main-categories">
        <div class="main-headphones">
            ...
            <a href="/catalog""><img src="../assets/img/main-headphones.png" alt="none"></a>
        </div>
        <div class="main-speakers">
            <div class="main-speakers title">SPEAKERS</div>
            <a href="/catalog""><img src="../assets/img/main-speakers.png" alt="none"></a>
        </div>
        <div class="main-turntables">
            <div class="main-turntables title">TURNTABLES</div>
            <a href="/catalog"><img src="../assets/img/main-turntables.png" alt="none"></a>
        </div>
        <div class="main-amplifiers">
            <div class="main-amplifiers title">AMPLIFIERS</div>
            <a href="/catalog""><img src="../assets/img/main-amplifiers.png" alt="none"></a>
        </div>
        <div class="main-soundbars">
            <div class="main-soundbars title">SOUNDBARS</div>
            <a href="/catalog""><img src="../assets/img/main-soundbars.png" alt="none"></a>
        </div>
        <div class="main-controllers">
            <div class="main-controllers title">DJ Controllers</div>
            <a href="/catalog""><img src="../assets/img/main-controllers.png" alt="none"></a>
        </div>
    </div>
